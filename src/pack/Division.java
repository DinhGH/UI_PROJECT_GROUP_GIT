...
public class Division extends JFrame {
	...
	public Division() {
		...
		btnDivide.setFont(new Font("Segoe UI", Font.BOLD, 18));
		btnDivide.setBackground(new Color(100, 149, 237));
		btnDivide.setForeground(Color.WHITE);
		btnDivide.setFocusPainted(false);
		btnDivide.setPreferredSize(new Dimension(100, 40));
		btnDivide.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseEntered(java.awt.event.MouseEvent evt) {
				btnDivide.setBackground(new Color(70, 130, 180));
			}
		...
		btnDivide.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (num2 == 0) {
						JOptionPane.showMessageDialog(Division.this, "Cannot divide by zero!", 
					...
					JOptionPane.showMessageDialog(Division.this, "Please enter valid numbers!", 
						"Input Error", JOptionPane.ERROR_MESSAGE);
					lblResult.setText(""); 
				}
			}
